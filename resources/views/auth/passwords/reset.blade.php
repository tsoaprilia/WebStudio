      ...
      <div class="row">
        <div class="col-sm-6 px-0 d-none d-sm-block">
          ...
          <div class="d-flex align-items-center h-custom-2 mt-5 pt-5 pt-xl-0 mt-xl-n5">
            ...
            <form method="POST"  style="width: 23rem;" action="{{ route('password.update') }}">
                @csrf
            ...
            <div class="form-outline mb-4">
                ...
                <div class="input-group">
                    <input style="font-size: 14px; margin-top:10px;" id="password" type="password" class="form-control form-control-lg form-control-sm @error('password') is-invalid @enderror" name="password" required autocomplete="new-password">
                </div>
                @error('password')
                    <span class="invalid-feedback" role="alert">
                        <strong>{{ $message }}</strong>
            ...
            <div class="form-outline mb-4">
                <label class="form-label" for="form2Example28">{{ __('Konfirm Password') }}</label>
                <div class="input-group">
                    <input style="font-size: 14px;" id="password-confirm" type="password" class="form-control form-control-lg form-control-sm" name="password_confirmation" required autocomplete="new-password">
                </div>
            </div>

              <div class="pt-1 mb-4">
                <button class="btn btn-info btn-lg btn-block" type="submit" style="font-size: 16px;">  {{ __('Reset Password') }}</button>
              </div>
